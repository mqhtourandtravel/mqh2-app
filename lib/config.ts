...
export const HERO_IMG = process.env.NEXT_PUBLIC_HERO_IMG || '/images/madinah-mosque.jpg'
export const HERO_VIDEO = process.env.NEXT_PUBLIC_HERO_VIDEO || 'https://www.youtube.com/watch?v=2isXJr0BTnU'
